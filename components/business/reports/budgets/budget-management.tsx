...
import {
	buildChartPages,
	formatChartValue,
} from '@/components/business/reports/budgets/calculations';
import { MetricCard } from '@/components/business/reports/budgets/metric-card';
import { OverviewTab } from '@/components/business/reports/budgets/tabs/overview-tab';
import { PerformanceTab } from '@/components/business/reports/budgets/tabs/performance-tab';
import { SourcesAndMaterialsTab } from '@/components/business/reports/budgets/tabs/sources-and-materials-tab';
import { ArchitectsTab } from '@/components/business/reports/budgets/tabs/architects-tab';
