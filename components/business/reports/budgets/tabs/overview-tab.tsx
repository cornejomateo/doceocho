...
import { SumTicketCard } from '@/components/business/reports/budgets/sum-ticket-card';
import { SalesMetrics } from '@/lib/reports/budgets/types';
			...
			<Card className="p-6 bg-card border-border">
				...
				<ChartsCarousel
					...
					percentageLabels={{
						...
						'De ventas':
							percentages.soldPercentage > 0
								? Math.round(
										((metrics.totalSales * metrics.soldAverageTicket) / metrics.totalRevenue) * 100
									)
								: 0,
